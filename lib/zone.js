...
/**
 * Used to sand any kind of hexabyte code to the lamps
 * @param {Function} callback
 * @param {Array} customCommand
 */
Zone.prototype.customCommand = function(customCommand) {
	var callback = _defaultCallback;
